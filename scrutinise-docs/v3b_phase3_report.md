...
Full investigation: `scrutinise-docs/v3b_phase3_report.md#bug-investigation-json-parse-errors`.
...
Full investigation: `scrutinise-docs/v3b_isbn_overflow_investigation.md`
