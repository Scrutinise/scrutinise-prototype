...
1. Build the inquiry register: enumerate from gov.uk's inquiries list + the Web Archive's inquiry collection; output `scrutinise-docs/INQUIRIES_UNIVERSE.md` (inquiry | status | site | reports | transcripts/evidence | est. size | licence).
