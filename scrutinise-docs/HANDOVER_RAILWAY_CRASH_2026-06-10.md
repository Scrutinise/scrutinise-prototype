...
- **Docs:** `scrutinise-docs/INGEST_PLAYBOOK.md` (§8 failure patterns, §9 source access priority, §9a Neon migration), `handoff_summary.md`, `CHANGE_LOG.md`, root `CLAUDE.md` (Railway ops: staggered restart, `backboard.railway.com/graphql/v2` not `api.railway.app`, `deploymentRedeploy` vs `serviceInstanceRedeploy`)
