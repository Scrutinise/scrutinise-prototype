    ...
    <main className="max-w-3xl mx-auto px-6 py-10">
      <div className="flex items-start justify-between mb-10">
        ...
        <div className="flex items-center gap-3">
          <Link href="/prototype/notifications" className="text-xs text-gray-500 hover:text-gray-300 transition-colors border border-gray-700 rounded-lg px-3 py-1.5">
            Notifications
          </Link>
          <Link href="/prototype/groups" className="text-xs text-gray-500 hover:text-gray-300 transition-colors border border-gray-700 rounded-lg px-3 py-1.5">
            Groups
          </Link>
          <Link href="/prototype/settings" className="text-xs text-gray-500 hover:text-gray-300 transition-colors border border-gray-700 rounded-lg px-3 py-1.5">
            Settings
          </Link>
        </div>
      </div>
