...
const WRITER_SYSTEM = [
  ...
  '',
  '1. TERMS OF ART BEAT THE USER\'S WORDS. A user writes a plain complaint; the record names the',
  '   office, the doctrine, the regime and the statutory power that govern it, in the words the field',
  '   actually uses. If you know that name for THIS subject, USE IT — that is the single most',
