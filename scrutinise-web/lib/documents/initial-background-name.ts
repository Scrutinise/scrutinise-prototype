...
//
// ⚠ THE CAVEAT IS CHARLIE'S COPY, VERBATIM. Do not paraphrase it in place; change the
// brief, then change this. It is the first thing in the document, before the beta
// disclosure and before the briefing itself.
//
...
export const FIRST_PASS_CAVEAT =
  ...
  + 'what you have told us so far. The more you tell us, the better it gets — as you work through the '
  + 'questions and decisions Lex has laid out, this list is refined into something more accurate and '
  + 'more specific to your proposal.'
