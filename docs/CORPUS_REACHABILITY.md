...
*Generated 2026-08-09 21:43 UTC by `scripts/ingest/search/corpus-reachability.ts`. Machine-readable
...
**The one number.** 17,121,546 of 18,383,172 sections (93.1%) sit in a collection some router stream can select. 4 collections are reachable by no path at all; 13 surface only when routing is off or has failed open; 0 only via an explicit-tier caller.
...
|---|---:|---:|---:|---|---|---|---|---:|---|
| `bills-api` | 6,574 | 6,535 | 31,649 | BILL | parliamentary | **NONE** | — | — | keyword-only |
...
| `committees-reports` | 344,773 | 323,922 | 331,924 | COMMITTEE | parliamentary | committees | — | 15 | reachable |
...
| `erskine-may` | 2,038 | 1,873 | 2,130 | **null (dropped)** | other | **NONE** | — | — | **UNREACHABLE** |
...
| `explanatory-memoranda` | 27,428 | 21,984 | 22,022 | **null (dropped)** | legislation | **NONE** | — | — | **UNREACHABLE** |
| `explanatory-notes` | 18,801 | 18,651 | 2,965 | **null (dropped)** | legislation | **NONE** | — | 4 | **UNREACHABLE** |
...
| `ico` | 26,591 | 26,562 | 128,800 | GUIDANCE | guidance | guidance | — | 1 | reachable |
...
| `lgsco` | 40 | 40 | 32 | GUIDANCE | other | **NONE** | — | — | keyword-only |
| `members-interests` | 3,448 | 3,448 | 680 | **null (dropped)** | other | **NONE** | — | — | **UNREACHABLE** |
...
| `ofgem` | 17,161 | 17,143 | 57,999 | GUIDANCE | other | **NONE** | — | — | keyword-only |
| `ots-reports` | 497 | 497 | 854 | GUIDANCE | guidance | guidance | — | — | reachable |
| `parliament-treaties` | 328 | 328 | 0 | DEBATE | parliamentary | debates | — | — | reachable |
| `petitions` | 49,529 | 49,529 | 50,254 | DEBATE | other | **NONE** | — | 9 | keyword-only |
| `planning-policy` | 64 | 64 | 433 | GUIDANCE | guidance | guidance | — | — | reachable |
| `primary-acts-2000plus` | 145,767 | 145,704 | 148,934 | PRIMARY_LEGISLATION | legislation | legislation | 3 legacy | 6 | reachable |
| `primary-acts-pre-2000` | 172,995 | 165,438 | 171,636 | PRIMARY_LEGISLATION | legislation | legislation | 3 legacy | 3 | reachable |
| `pwdata-debates` | 6,391,345 | 6,387,314 | 7,092,149 | DEBATE | parliamentary | debates | — | 17 | reachable |
| `pwdata-lords` | 754,546 | 752,809 | 936,642 | DEBATE | parliamentary | debates | — | 11 | reachable |
| `pwdata-lordswms` | 21,463 | 20,932 | 27,972 | DEBATE | parliamentary | debates | — | 1 | reachable |
...
| `uk-treaties-fcdo` | 23,372 | 23,372 | 0 | DEBATE | parliamentary | debates | — | — | reachable |
...
|---|---:|---:|---:|
| reachable | 53 | 17,121,546 | 16,913,438 |
| tier-only | 0 | 0 | 0 |
| keyword-only | 13 | 1,209,911 | 1,207,532 |
| UNREACHABLE | 4 | 51,715 | 45,956 |
...
| members' interests | `members-interests` | 3,448 | **NONE** | **UNREACHABLE** |
...
| explanatory notes | `explanatory-memoranda` | 27,428 | **NONE** | **UNREACHABLE** |
| explanatory notes | `explanatory-notes` | 18,801 | **NONE** | **UNREACHABLE** |
...
- **4** are satisfied in part by an UNREACHABLE collection — the scoring harness reads Lance directly, the app's FTS adapter drops those rows for having no display type. To that extent the recall number measures the index rather than the product.
...
| B1 | legislation | 0/4 | 0/20 | — | no key hit |
...
| C5 | legislation + guidance | 3/3 | 1/20 | `pwdata-debates`×3, `pwdata-westminster`×3, `si-2010plus`×1, `committees-reports`×1, `petitions`×1 ⚠ | ok (⚠ partly unroutable) |
...
| F3 | bills + debates | 2/2 | 13/20 | `pwdata-wrans`×2, `pwdata-lordswrans`×2, `regional`×1, `committees-evidence`×1, `explanatory-notes`×1 ✗ | ok (✗ partly undeliverable) |
...
| B6 | legislation | 0/6 | 6/20 | — | no key hit |
...
- reachable by these callers AND by the router: 7 collections (1,916,000 sections)
