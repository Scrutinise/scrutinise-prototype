...
*Generated 2026-09-09 04:01 UTC.*
...
| Measure | Target resolved | Matched on | People with a record |
|---|---|---|---|
| M-01 | European Convention on Human Rights (withdrawal): Ten Minute Rule Motion | 3w — "european convention on human" | 254 |
| M-02 | Consequences of the Equality Act 2010 | 2w — "equality act 2010" | 1 |
| M-03 | Supreme Court judgment on religious education in Northern Ireland | 2w — "supreme court" | 1 |
| M-04 | ADVERTISING STANDARDS AUTHORITY AND RELIGIOUS LIBERTY | 2w — "advertising standards" | 1 |
| M-05 | Judicial review on miscarriages of justice between 1982 and 2016 | 2w — "judicial review" | 1 |
| M-06 | Civil Service pensions | 2w — "civil service" | 1 |
| M-07 | Independence of the Bank of England | 2w — "independence of the bank" | 1 |
| M-08 | Civil Service pensions | 2w — "civil service" | 1 |
| M-09 | **none** | — | — |
| M-10 | Maintaining institutional neutrality of publicly funded buildings and spaces | 2w — "publicly funded" | 1 |
| M-11 | Sentencing Guidelines (Pre-sentence Reports) Bill | 2w — "sentencing guidelines" | 189 |
| M-12 | **none** | — | — |

**2 of 12 measures return more than one person.** 8 return exactly one and 2 resolve to no target at all.

⚠ **The ones returning exactly one person are early day motions, and that is a corpus gap rather than a finding about the measure.** We hold 60,995 motions and, for each, only the member who tabled it — 1.00 per motion, against the 2,125,547 signatories Parliament publishes. An EDM target can therefore only ever return one name. The two measures that return hundreds are divisions, where the whole voting record is held.

⚠⚠ **And several targets are simply the wrong subject.** The mapping from a broad proposal to specific parliamentary business is a phrase match, and the disclosure line under each measure shows how thin it is. On this run the arm's-length body estate resolved to a motion about advertising standards on the two words *"advertising standards"*; diversity practice in the civil service and the civil service model itself both resolved to the same motion, about **Civil Service pensions**, on the two words *"civil service"*; and charities campaigning resolved to a motion about publicly funded buildings on *"publicly funded"*.

**Conclusion: this cannot be published as a per-measure supporter and opponent register.** For most measures it is either the wrong subject or a single name. Where it is useful is the two division-backed measures, and there it is useful as a list to work down and confirm, which is what it is presented as.
...
⚠ **This is not a ranking.** The order is the order the query returned; where several people have an identical record there is no meaningful order between them.
...
1 person has a record against this target.

| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Andrew Rosindell ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Consequences of the Equality Act 2010 (2025-07-22) | [record](https://edm.parliament.uk/early-day-motion/64141) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Mr Gregory Campbell ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Supreme Court judgment on religious education in Northern Ireland (2025-11-24) | [record](https://edm.parliament.uk/early-day-motion/64791) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Sir Gary Streeter ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | ADVERTISING STANDARDS AUTHORITY AND RELIGIOUS LIBERTY (2012-06-13) | [record](https://edm.parliament.uk/early-day-motion/44322) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Liz Saville Roberts ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Judicial review on miscarriages of justice between 1982 and 2016 (2023-05-02) | [record](https://edm.parliament.uk/early-day-motion/60849) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Freddie van Mierlo ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Civil Service pensions (2026-06-01) | [record](https://edm.parliament.uk/early-day-motion/65948) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Mrs Teresa Gorman ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Independence of the Bank of England (1989-12-05) | [record](https://edm.parliament.uk/early-day-motion/1767) |
...
| Person | Party at the time | What the record shows | On what | Source |
|---|---|---|---|---|
| Andrew Rosindell ⚠ | — | tabled an early day motion (⚠ sponsorship — we hold no signatures), **for** | Maintaining institutional neutrality of publicly funded buildings and spaces (2025-06-12) | [record](https://edm.parliament.uk/early-day-motion/63844) |
