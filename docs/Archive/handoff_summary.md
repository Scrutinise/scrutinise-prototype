...
> Read `CLAUDE.md` and `CC_briefing_next_session.md` in `docs/`. The prototype is feature-complete and fully styled with the v0 design system. Priority: mobile optimisation pass — test all pages at 375px viewport, fix any layout breaks. Then begin Sprint 1 per `implementation_plan.md`.
