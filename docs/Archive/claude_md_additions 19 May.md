...
Two sections to add to `docs/CLAUDE.md`. Insert under the appropriate section heading (likely "Engineering practices" or "Diagnostic protocols" — CC to choose placement).
