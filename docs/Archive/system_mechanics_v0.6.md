...
- All votes: −5 to +5 in 0.5 increments
- Raw and unweighted — no vote weight mechanism of any kind
- Public — vote values visible to all
- One vote per user per idea
- Email verification required before voting
- IP rate limit: 20 votes per hour per IP address

### 5.2 Vote Changes

If a user changes their vote value:
