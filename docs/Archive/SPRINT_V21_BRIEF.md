...
3. Output: `docs/QUANGO_UNIVERSE.md` — ranked table: organisation | body type | total docs | docs by format | on-gov.uk vs external-site flag. Plus a CSV alongside for the Corpus Status xls.
