...
| Document              | Location                                            |
|-----------------------|-----------------------------------------------------|
| Handoff summary       | `docs/handoff_summary.md` (v25)          |
| CLAUDE.md             | `docs/CLAUDE.md`                         |
| Entity list           | `docs/entity_list_v5.md`                 |
| System mechanics      | `docs/system_mechanics_v0_8.md`          |
| CHANGE_LOG            | `docs/CHANGE_LOG.md`                     |
