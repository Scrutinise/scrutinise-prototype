...
**Status:** Draft for build. This is the authoritative spec for the Lex conversation layer. Every future CC brief on Lex references this document. It is the Lex equivalent of `INGEST_PLAYBOOK.md`.
