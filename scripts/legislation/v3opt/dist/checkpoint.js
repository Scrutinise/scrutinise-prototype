...
exports.loadWorkerCheckpoint = loadWorkerCheckpoint;
exports.saveWorkerCheckpoint = saveWorkerCheckpoint;
...
function checkpointPath(dir, workerId) {
    return path.join(dir, `checkpoint-worker-${workerId}.json`);
}
function loadWorkerCheckpoint(dir, workerId) {
    try {
...
function saveWorkerCheckpoint(dir, workerId, cp) {
    fs.writeFileSync(checkpointPath(dir, workerId), JSON.stringify(cp, null, 2), 'utf8');
}
function aggregateStats(checkpoints) {
