...
const SCOPE_DECLARATIONS: Record<string, string> = {
  ...
  'ots-reports': '⚠ SCOPE NOT HONOURED BY THE DATA. Intended: publications of the Office of Tax Simplification (222 documents by the publisher\'s own organisation filter). Actual: the first 500 results of a free-text gov.uk relevance search over 347,938 — 421 of 497 rows were published by somebody else. See OI-1.',
