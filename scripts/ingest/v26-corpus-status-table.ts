/**
 * v26-corpus-status-table.ts — per-corpus sections | words | R2 bytes | Neon bytes
 * table for the Corpus Status workbook, regenerated after the V26 Migration-A
 * gap-fill drained (si-pre-2010 → 419k, primary-acts-2000plus → 145k, etc.) and
 * the V25 bills-api / senedd-cofnod drains completed.
 *
 * Measures (identical methodology to V24/V25 — comparable across sprints):
