/**
 * v30-corpus-status-table.ts — per-corpus sections | words | R2 bytes | Neon bytes
 * table for the Corpus Status workbook. Run POST-DRAIN of the V30 seeds
 * (cma-cases, scottish-parliament-or 2016+ AND pre-2016, inquiry-evidence,
 * any pinned own-domain reviews). Methodology identical to V24–V29 so columns
 * stay comparable.
 *
 * Outputs: markdown table to stdout + docs/CORPUS_STATUS_V30.csv
...
const OUT_CSV = path.join(__dirname, '../../docs/CORPUS_STATUS_V30.csv')
