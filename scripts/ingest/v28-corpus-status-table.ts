/**
 * v28-corpus-status-table.ts — per-corpus sections | words | R2 bytes | Neon bytes
 * table for the Corpus Status workbook. Run POST-DRAIN of the V28 seeds
 ...
 *
 * Outputs: markdown table to stdout + docs/CORPUS_STATUS_V28.csv
...
const OUT_CSV = path.join(__dirname, '../../docs/CORPUS_STATUS_V28.csv')
