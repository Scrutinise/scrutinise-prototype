/**
 * v22-corpus-status-table.ts — V24 §8 deliverable (Charlie): per-corpus
 ...
 *
 * Outputs: markdown table to stdout + scrutinise-docs/CORPUS_STATUS_V24.csv.
 */
...
const OUT_CSV = path.join(__dirname, '../../scrutinise-docs/CORPUS_STATUS_V24.csv')
