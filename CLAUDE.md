...
1. `scrutinise-docs/CLAUDE.md` — project rules, terminology, architecture, git policy
2. `scrutinise-docs/entity_list_v5.md` — every DB entity and field (never edit without Charlie's instruction)
3. `scrutinise-docs/system_mechanics_v0_8.md` — current business rules
4. `scrutinise-docs/handoff_summary.md` — current sprint state and where we left off
